...
//
    ...
    def c3, 0, 5, 18, -0.25
    def c4, -0.5, 0.5, 0.9, 9.99999975e-005
    def c5, 1.5, -0.4548159977, 0.2077075065, 0.0833333358
    def c6, 0, 0.5, -0.100000001, 1.11111116
    def c7, 0.212500006, 0.715399981, 0.0720999986, 1.00000001e-007
    def c8, 1, -1, 0, -0
    def c9, 0.4548159977, 0.2077075065, 0, 0
    def c10, 0.3778747872, -0.327430367, 0.2703204087, 0.4206267664
    def c11, -0.1408662784, -0.4797464868, 0.4949107209, -0.07115741914
    def c12, -0.4949107209, -0.07115741914, 0.1408662784, -0.4797464868
    def c13, -0.2703204087, 0.4206267664, -0.3778747872, -0.327430367
    def c98, 0.5, 2, 0.1, 0
    dcl_texcoord v0.xy
    dcl_texcoord1 v1
    ...
    add r0.z, r0.z, -c98.z
    mad r1.xz, r3.xy, c5.yyzw, r0.xyyw
    texld r2, r1.xzzw, s15
    add r0.w, r0.z, -r2.x
    cmp r0.w, r0.w, c1.z, c1.w
    mad r1.xz, r3.xy, c13.xyyw, r0.xyyw
    texld r2, r1.xzzw, s15
    add r1.x, r0.z, -r2.x
    cmp r1.x, r1.x, c1.z, c1.w
    add r0.w, r0.w, r1.x
    mad r1.xz, r3.xy, c13.zyww, r0.xyyw
    texld r2, r1.xzzw, s15
    add r1.x, r0.z, -r2.x
    cmp r1.x, r1.x, c1.z, c1.w
    add r0.w, r0.w, r1.x
    mad r1.xz, r3.xy, c12.xyyw, r0.xyyw
    texld r2, r1.xzzw, s15
    add r1.x, r0.z, -r2.x
    cmp r1.x, r1.x, c1.z, c1.w
    add r0.w, r0.w, r1.x
    mad r1.xz, r3.xy, c12.zyww, r0.xyyw
    texld r2, r1.xzzw, s15
    add r1.x, r0.z, -r2.x
    cmp r1.x, r1.x, c1.z, c1.w
    add r0.w, r0.w, r1.x
