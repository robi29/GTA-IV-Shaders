...
//
    ...
    mad r5.xz, r7.xy, c11.xyyw, r2.xyyw
    texld r6, r5.xzzw, s15
    add r3.w, r2.z, -r6.x
    cmp r3.w, r3.w, -c0.y, -c0.z
    add r3.z, r3.z, r3.w
    mad r5.xz, r7.xy, c11.zyww, r2.xyyw
    texld r6, r5.xzzw, s15
    add r3.w, r2.z, -r6.x
    cmp r3.w, r3.w, -c0.y, -c0.z
    add r3.z, r3.z, r3.w
...
// approximately 167 instruction slots used (15 texture, 152 arithmetic)
