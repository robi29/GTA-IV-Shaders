...
//
    ...
    add r2.w, r2.w, -c98.z
    mad r4.xz, r7.xy, c2.yyzw, r1.zyww
    texld r6, r4.xzzw, s15
    add r3.w, r2.w, -r6.x
    cmp r3.w, r3.w, -c0.y, -c0.z
    mad r4.xz, r7.xy, c11.xyyw, r1.zyww
    texld r6, r4.xzzw, s15
    add r4.x, r2.w, -r6.x
    cmp r4.x, r4.x, -c0.y, -c0.z
    add r3.w, r3.w, r4.x
    mad r4.xz, r7.xy, c11.zyww, r1.zyww
    texld r6, r4.xzzw, s15
    add r4.x, r2.w, -r6.x
    cmp r4.x, r4.x, -c0.y, -c0.z
    add r3.w, r3.w, r4.x
    mad r4.xz, r7.xy, c10.xyyw, r1.zyww
    texld r6, r4.xzzw, s15
    add r4.x, r2.w, -r6.x
    cmp r4.x, r4.x, -c0.y, -c0.z
    add r3.w, r3.w, r4.x
    mad r4.xz, r7.xy, c10.zyww, r1.zyww
    texld r6, r4.xzzw, s15
    add r4.x, r2.w, -r6.x
    cmp r4.x, r4.x, -c0.y, -c0.z
    add r3.w, r3.w, r4.x
    mad r4.xz, r7.xy, c9.xyyw, r1.zyww
    texld r6, r4.xzzw, s15
    add r4.x, r2.w, -r6.x
    cmp r4.x, r4.x, -c0.y, -c0.z
    add r3.w, r3.w, r4.x
    mad r4.xz, r7.xy, c9.zyww, r1.zyww
    texld r6, r4.xzzw, s15
    add r4.x, r2.w, -r6.x
    cmp r4.x, r4.x, -c0.y, -c0.z
    add r3.w, r3.w, r4.x
    mad r4.xz, r7.xy, c8.xyyw, r1.zyww
    texld r6, r4.xzzw, s15
    add r4.x, r2.w, -r6.x
    cmp r4.x, r4.x, -c0.y, -c0.z
    add r3.w, r3.w, r4.x
    mad r4.xz, r7.xy, c8.zyww, r1.zyww
    texld r6, r4.xzzw, s15
    add r4.x, r2.w, -r6.x
    cmp r4.x, r4.x, -c0.y, -c0.z
    add r3.w, r3.w, r4.x
    mad r4.xz, r7.xy, c7.xyyw, r1.zyww
    texld r6, r4.xzzw, s15
    add r4.x, r2.w, -r6.x
    cmp r4.x, r4.x, -c0.y, -c0.z
    add r3.w, r3.w, r4.x
    mad r4.xz, r7.xy, c7.zyww, r1.zyww
    texld r6, r4.xzzw, s15
    add r4.x, r2.w, -r6.x
    cmp r4.x, r4.x, -c0.y, -c0.z
    add r3.w, r3.w, r4.x
