...
//
    ...
    def c5, 1.5, -0.4548159977, 0.2077075065, 0.0833333358
    def c6, 0, 0.5, -0.5, 0.5
    def c7, 0.0199999996, 0.00999999978, 0.75, 0.25
    def c8, 5, 10, 0, 0
    def c9, 1, -1, 0, -0
    def c10, 0.4548159977, 0.2077075065, 0, 0
    def c11, 0.3778747872, -0.327430367, 0.2703204087, 0.4206267664
    def c12, -0.1408662784, -0.4797464868, 0.4949107209, -0.07115741914
    def c13, -0.4949107209, -0.07115741914, 0.1408662784, -0.4797464868
    def c16, -0.2703204087, 0.4206267664, -0.3778747872, -0.327430367
    def c98, 23, 0.25, 0.15, 0
    def c99, 0.5, 2, 0, 0
    dcl_texcoord v0.xy
    dcl_texcoord1 v1
    dcl_2d s0
    ...
    mov r1.y, c53.y
    mul r9.xy, r1.yy, c99.xy
    mad r8.x, r8.x, -c98.y, c98.z
    add r1.z, r1.z, r8.x
    mad r1.xw, r9.xy, c5.yyzz, r0.zyzw
    texld r2, r1.xwzw, s15
    add r1.x, r1.z, -r2.x
    cmp r1.x, r1.x, c4.z, c4.w
    mad r2.xy, r9.xy, c16, r0.zwzw
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r1.x, r1.x, r1.w
    mad r2.xy, r9.xy, c16.zwzw, r0.zwzw
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r1.x, r1.x, r1.w
    mad r2.xy, r9.xy, c13, r0.zwzw
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r1.x, r1.x, r1.w
    mad r2.xy, r9.xy, c13.zwzw, r0.zwzw
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r1.x, r1.x, r1.w
    mad r2.xy, r9.xy, c12, r0.zwzw
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r1.x, r1.x, r1.w
    mad r2.xy, r9.xy, c12.zwzw, r0.zwzw
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r1.x, r1.x, r1.w
    mad r2.xy, r9.xy, c11, r0.zwzw
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r1.x, r1.x, r1.w
    mad r2.xy, r9.xy, c11.zwzw, r0.zwzw
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r1.x, r1.x, r1.w
    mad r2.xy, r9.xy, c10, r0.zwzw
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r1.x, r1.x, r1.w
    mad r2.xy, r9.xy, c10.zwzw, r0.zwzw
    mad r0.zw, r9.xy, c6.xyxy, r0
