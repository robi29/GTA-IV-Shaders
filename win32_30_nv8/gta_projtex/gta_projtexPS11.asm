...
//
    ...
    add r5.z, r5.z, -c98.z
    mad r6.xy, r7.xy, c2.zwzw, r1.yzzw
    texld r6, r6, s15
    add r5.w, r5.z, -r6.x
    cmp r5.w, r5.w, c1.y, c1.z
    mad r6.xy, r7.xy, c11, r1.yzzw
    texld r6, r6, s15
    add r6.x, r5.z, -r6.x
    cmp r6.x, r6.x, c1.y, c1.z
    add r5.w, r5.w, r6.x
    mad r6.xy, r7.xy, c11.zwzw, r1.yzzw
    texld r6, r6, s15
    add r6.x, r5.z, -r6.x
    cmp r6.x, r6.x, c1.y, c1.z
    add r5.w, r5.w, r6.x
    mad r6.xy, r7.xy, c10, r1.yzzw
    texld r6, r6, s15
    add r6.x, r5.z, -r6.x
    cmp r6.x, r6.x, c1.y, c1.z
    add r5.w, r5.w, r6.x
    mad r6.xy, r7.xy, c10.zwzw, r1.yzzw
    texld r6, r6, s15
    add r6.x, r5.z, -r6.x
    cmp r6.x, r6.x, c1.y, c1.z
    add r5.w, r5.w, r6.x
    mad r6.xy, r7.xy, c9, r1.yzzw
    texld r6, r6, s15
    add r6.x, r5.z, -r6.x
    cmp r6.x, r6.x, c1.y, c1.z
    add r5.w, r5.w, r6.x
    mad r6.xy, r7.xy, c9.zwzw, r1.yzzw
    texld r6, r6, s15
    add r6.x, r5.z, -r6.x
    cmp r6.x, r6.x, c1.y, c1.z
    add r5.w, r5.w, r6.x
    mad r6.xy, r7.xy, c8, r1.yzzw
    texld r6, r6, s15
    add r6.x, r5.z, -r6.x
    cmp r6.x, r6.x, c1.y, c1.z
    add r5.w, r5.w, r6.x
    mad r6.xy, r7.xy, c8.zwzw, r1.yzzw
    texld r6, r6, s15
    add r6.x, r5.z, -r6.x
    cmp r6.x, r6.x, c1.y, c1.z
    add r5.w, r5.w, r6.x
    mad r6.xy, r7.xy, c7, r1.yzzw
    texld r6, r6, s15
    add r6.x, r5.z, -r6.x
    cmp r6.x, r6.x, c1.y, c1.z
    add r5.w, r5.w, r6.x
    mad r6.xy, r7.xy, c7.zwzw, r1.yzzw
    texld r6, r6, s15
    add r6.x, r5.z, -r6.x
    cmp r6.x, r6.x, c1.y, c1.z
    add r5.w, r5.w, r6.x
    mad r1.yz, r7.xxyy, c4.xxyw, r1
