...
//
    ...
    add r6.z, r6.z, -c98.z
    mad r6.xw, r8.xy, c1.yyzz, r1.zyzw
    texld r7, r6.xwzw, s15
    add r6.x, r6.z, -r7.x
    cmp r6.x, r6.x, -c2.y, -c2.z
    mad r7.xy, r8.xy, c11, r1.zwzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, -c2.y, -c2.z
    add r6.x, r6.x, r6.w
    mad r7.xy, r8.xy, c11.zwzw, r1.zwzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, -c2.y, -c2.z
    add r6.x, r6.x, r6.w
    mad r7.xy, r8.xy, c10, r1.zwzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, -c2.y, -c2.z
    add r6.x, r6.x, r6.w
    mad r7.xy, r8.xy, c10.zwzw, r1.zwzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, -c2.y, -c2.z
    add r6.x, r6.x, r6.w
    mad r7.xy, r8.xy, c9, r1.zwzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, -c2.y, -c2.z
    add r6.x, r6.x, r6.w
    mad r7.xy, r8.xy, c9.zwzw, r1.zwzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, -c2.y, -c2.z
    add r6.x, r6.x, r6.w
    mad r7.xy, r8.xy, c8, r1.zwzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, -c2.y, -c2.z
    add r6.x, r6.x, r6.w
    mad r7.xy, r8.xy, c8.zwzw, r1.zwzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, -c2.y, -c2.z
    add r6.x, r6.x, r6.w
    mad r7.xy, r8.xy, c7, r1.zwzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, -c2.y, -c2.z
    add r6.x, r6.x, r6.w
    mad r7.xy, r8.xy, c7.zwzw, r1.zwzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, -c2.y, -c2.z
    add r6.x, r6.x, r6.w
    mad r1.zw, r8.xyxy, c3.xyxy, r1
