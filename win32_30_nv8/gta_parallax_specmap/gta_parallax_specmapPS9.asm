...
//
    ...
    add r2.w, r2.w, -c98.z
    mad r3.xy, r7.xy, r3.zwzw, r2.yzzw
    texld r3, r3, s15
    add r3.x, r2.w, -r3.x
    cmp r3.x, r3.x, -c1.y, -c1.z
    mad r3.zw, r7.xyxy, c11.xyxy, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r3.zw, r7.xyxy, c11, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r3.zw, r7.xyxy, c10.xyxy, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r3.zw, r7.xyxy, c10, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r3.zw, r7.xyxy, c9.xyxy, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r3.zw, r7.xyxy, c9, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r3.zw, r7.xyxy, c8.xyxy, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r3.zw, r7.xyxy, c8, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r3.zw, r7.xyxy, c7.xyxy, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r3.zw, r7.xyxy, c7, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r2.yz, r7.xxyy, c3.xxyw, r2
