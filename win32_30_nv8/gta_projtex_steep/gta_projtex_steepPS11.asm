...
//
    ...
    def c2, 1, 0, -0.5, 0.5
    def c3, -0.25, 0.9, 1.5, 0.0833333358
    ...
    add r5.z, r5.z, -c98.z
    mad r5.xw, r7.xy, c12.xyzy, r1.zyzw
    texld r6, r5.xwzw, s15
    add r5.x, r5.z, -r6.x
    cmp r5.x, r5.x, c2.x, c2.y
    mad r6.xy, r7.xy, c12.zwzw, r1.zwzw
    texld r6, r6, s15
    add r5.w, r5.z, -r6.x
    cmp r5.w, r5.w, c2.x, c2.y
    add r5.x, r5.x, r5.w
    mad r6.xy, r7.xy, c11, r1.zwzw
    texld r6, r6, s15
    add r5.w, r5.z, -r6.x
    cmp r5.w, r5.w, c2.x, c2.y
    add r5.x, r5.x, r5.w
    mad r6.xy, r7.xy, c11.zwzw, r1.zwzw
    texld r6, r6, s15
    add r5.w, r5.z, -r6.x
    cmp r5.w, r5.w, c2.x, c2.y
    add r5.x, r5.x, r5.w
    mad r6.xy, r7.xy, c10, r1.zwzw
    texld r6, r6, s15
    add r5.w, r5.z, -r6.x
    cmp r5.w, r5.w, c2.x, c2.y
    add r5.x, r5.x, r5.w
    mad r6.xy, r7.xy, c10.zwzw, r1.zwzw
    texld r6, r6, s15
    add r5.w, r5.z, -r6.x
    cmp r5.w, r5.w, c2.x, c2.y
    add r5.x, r5.x, r5.w
    mad r6.xy, r7.xy, c9, r1.zwzw
    texld r6, r6, s15
    add r5.w, r5.z, -r6.x
    cmp r5.w, r5.w, c2.x, c2.y
    add r5.x, r5.x, r5.w
    mad r6.xy, r7.xy, c9.zwzw, r1.zwzw
    texld r6, r6, s15
    add r5.w, r5.z, -r6.x
    cmp r5.w, r5.w, c2.x, c2.y
    add r5.x, r5.x, r5.w
    mad r6.xy, r7.xy, c8, r1.zwzw
    texld r6, r6, s15
    add r5.w, r5.z, -r6.x
    cmp r5.w, r5.w, c2.x, c2.y
    add r5.x, r5.x, r5.w
    mad r6.xy, r7.xy, c8.zwzw, r1.zwzw
    texld r6, r6, s15
    add r5.w, r5.z, -r6.x
    cmp r5.w, r5.w, c2.x, c2.y
    add r5.x, r5.x, r5.w
    mad r6.xy, r7.xy, c7, r1.zwzw
    texld r6, r6, s15
    add r5.w, r5.z, -r6.x
    cmp r5.w, r5.w, c2.x, c2.y
    add r5.x, r5.x, r5.w
