...
//
    ...
    def c2, 0.9, 9.99999975e-005, 1.5, 0.0833333358
    ...
    add r1.z, r1.z, -c98.z
    mad r2.zw, r7.xyxy, c11.xyxy, r1.xyxy
    texld r6, r2.zwzw, s15
    add r2.z, r1.z, -r6.x
    cmp r2.z, r2.z, -c0.y, -c0.z
    mad r5.xz, r7.xy, c11.zyww, r1.xyyw
    texld r6, r5.xzzw, s15
    add r2.w, r1.z, -r6.x
    cmp r2.w, r2.w, -c0.y, -c0.z
    add r2.z, r2.z, r2.w
    mad r5.xz, r7.xy, c10.xyyw, r1.xyyw
    texld r6, r5.xzzw, s15
    add r2.w, r1.z, -r6.x
    cmp r2.w, r2.w, -c0.y, -c0.z
    add r2.z, r2.z, r2.w
    mad r5.xz, r7.xy, c10.zyww, r1.xyyw
    texld r6, r5.xzzw, s15
    add r2.w, r1.z, -r6.x
    cmp r2.w, r2.w, -c0.y, -c0.z
    add r2.z, r2.z, r2.w
    mad r5.xz, r7.xy, c9.xyyw, r1.xyyw
    texld r6, r5.xzzw, s15
    add r2.w, r1.z, -r6.x
    cmp r2.w, r2.w, -c0.y, -c0.z
    add r2.z, r2.z, r2.w
    mad r5.xz, r7.xy, c9.zyww, r1.xyyw
    texld r6, r5.xzzw, s15
    add r2.w, r1.z, -r6.x
    cmp r2.w, r2.w, -c0.y, -c0.z
    add r2.z, r2.z, r2.w
    mad r5.xz, r7.xy, c8.xyyw, r1.xyyw
    texld r6, r5.xzzw, s15
    add r2.w, r1.z, -r6.x
    cmp r2.w, r2.w, -c0.y, -c0.z
    add r2.z, r2.z, r2.w
    mad r5.xz, r7.xy, c8.zyww, r1.xyyw
    texld r6, r5.xzzw, s15
    add r2.w, r1.z, -r6.x
    cmp r2.w, r2.w, -c0.y, -c0.z
    add r2.z, r2.z, r2.w
    mad r5.xz, r7.xy, c7.xyyw, r1.xyyw
    texld r6, r5.xzzw, s15
    add r2.w, r1.z, -r6.x
    cmp r2.w, r2.w, -c0.y, -c0.z
    add r2.z, r2.z, r2.w
    mad r5.xz, r7.xy, c7.zyww, r1.xyyw
    texld r6, r5.xzzw, s15
    add r2.w, r1.z, -r6.x
    cmp r2.w, r2.w, -c0.y, -c0.z
    add r2.z, r2.z, r2.w
    mad r5.xz, r7.xy, c6.xyyw, r1.xyyw
    texld r6, r5.xzzw, s15
    add r2.w, r1.z, -r6.x
    cmp r2.w, r2.w, -c0.y, -c0.z
    add r2.z, r2.z, r2.w
    mad r1.xy, r7.xy, c6.zwzw, r1
    texld r5, r1, s15
    add r1.x, r1.z, -r5.x
