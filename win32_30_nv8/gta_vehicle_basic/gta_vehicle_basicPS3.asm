...
//
    ...
    cmp r1.x, r1.x, c4.x, c4.y
    add r0.w, r0.w, r1.x
    mad r1.xz, r3.xy, c6.xyyw, r0.xyyw
    texld r2, r1.xzzw, s15
    add r1.x, r0.z, -r2.x
    cmp r1.x, r1.x, c4.x, c4.y
    add r0.w, r0.w, r1.x
    mad r1.xz, r3.xy, c6.zyww, r0.xyyw
    mad r0.xy, r3.xy, c2, r0
    texld r2, r0, s15
    add r0.x, r0.z, -r2.x
