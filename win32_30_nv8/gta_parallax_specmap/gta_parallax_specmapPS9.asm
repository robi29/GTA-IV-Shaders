...
//
    ...
    mad r3.zw, r7.xy, c11.xyxy, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r3.zw, r7.xy, c11, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r3.zw, r7.xy, c10.xyxy, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r3.zw, r7.xy, c10, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r3.zw, r7.xy, c9.xyxy, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r3.zw, r7.xy, c9, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r3.zw, r7.xy, c8.xyxy, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r3.zw, r7.xy, c8, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r3.zw, r7.xy, c7.xyxy, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r3.zw, r7.xy, c7, r2.xyyz
    texld r6, r3.zwzw, s15
    add r3.z, r2.w, -r6.x
    cmp r3.z, r3.z, -c1.y, -c1.z
    add r3.x, r3.x, r3.z
    mad r2.yz, r7.xy, c3.xxyw, r2
