...
//
    ...
    def c1, 9.99999975e-006, -0.5, 0.5, 0.9
    ...
    add r6.z, r6.z, -c98.z
    mad r6.xw, r8.xy, c3.zyzw, r1.xyzz
    texld r7, r6.xwzw, s15
    add r6.x, r6.z, -r7.x
    cmp r6.x, r6.x, c2.y, c2.x
    mad r7.xy, r8.xy, c12, r1.xzzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, c2.y, c2.x
    add r6.x, r6.x, r6.w
    mad r7.xy, r8.xy, c12.zwzw, r1.xzzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, c2.y, c2.x
    add r6.x, r6.x, r6.w
    mad r7.xy, r8.xy, c11, r1.xzzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, c2.y, c2.x
    add r6.x, r6.x, r6.w
    mad r7.xy, r8.xy, c11.zwzw, r1.xzzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, c2.y, c2.x
    add r6.x, r6.x, r6.w
    mad r7.xy, r8.xy, c10, r1.xzzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, c2.y, c2.x
    add r6.x, r6.x, r6.w
    mad r7.xy, r8.xy, c10.zwzw, r1.xzzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, c2.y, c2.x
    add r6.x, r6.x, r6.w
    mad r7.xy, r8.xy, c9, r1.xzzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, c2.y, c2.x
    add r6.x, r6.x, r6.w
    mad r7.xy, r8.xy, c9.zwzw, r1.xzzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, c2.y, c2.x
    add r6.x, r6.x, r6.w
    mad r7.xy, r8.xy, c8, r1.xzzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, c2.y, c2.x
    add r6.x, r6.x, r6.w
    mad r7.xy, r8.xy, c8.zwzw, r1.xzzw
    texld r7, r7, s15
    add r6.w, r6.z, -r7.x
    cmp r6.w, r6.w, c2.y, c2.x
    add r6.x, r6.x, r6.w
    mad r1.xz, r8.xy, c4.xyyw, r1
