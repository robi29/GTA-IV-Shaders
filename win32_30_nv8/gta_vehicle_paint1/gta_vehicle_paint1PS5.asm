...
//
    ...
    def c0, 9.99999975e-006, 19, 0.150000006, 0
    def c1, 1, 0, 6.80000019, 9.99999975e-005
    def c2, -13.2877121, 0.5, 0.1953125, 0
    def c3, 4.3, 1.9, 0.35, 0 // x - fresnel power, y - reflection side power, z - reflection front power
    dcl_texcoord v0.xy
    ...
    dp3 r8.x, -r7, r2
    mov_sat r8.y, -r8.x
    add r8.y, r8_abs.y, c1.x
    pow r8.y, r8.y, c3.x
    rcp r8.y, r8.y
    mad r8.y, r8.y, c3.y, c3.z
    texld r3, v0, s2
    mul r2.w, r3.w, c81.x
    mul r2.w, r2.w, c0.y
    mul r2.w, r2.w, r8.y
    ...
    mul r5.xyz, r3.x, c80
    add r3.x, r8.x, r8.x
    mad r2.xyz, r2, -r3.x, -r7
    dp3 r2.x, -c17, r2
    add r2.y, r2.x, c1.w
    log r2.y, r2.y
    cmp r2.x, r2.x, r2.y, c2.x
    mul r2.x, r3.y, r2.x
    exp r2.x, r2.x
