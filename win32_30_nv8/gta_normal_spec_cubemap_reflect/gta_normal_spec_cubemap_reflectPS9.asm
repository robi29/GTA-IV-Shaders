...
//
    ...
    add r2.z, r2.z, -c98.z
    mad r3.xz, r7.xy, c2.yyzw, r0.zyww
    texld r6, r3.xzzw, s15
    add r2.w, r2.z, -r6.x
    cmp r2.w, r2.w, c6.w, c6.x
    mad r3.xz, r7.xy, c11.xyyw, r0.zyww
    texld r6, r3.xzzw, s15
    add r3.x, r2.z, -r6.x
    cmp r3.x, r3.x, c6.w, c6.x
    add r2.w, r2.w, r3.x
    mad r3.xz, r7.xy, c11.zyww, r0.zyww
    texld r6, r3.xzzw, s15
    add r3.x, r2.z, -r6.x
    cmp r3.x, r3.x, c6.w, c6.x
    add r2.w, r2.w, r3.x
    mad r3.xz, r7.xy, c10.xyyw, r0.zyww
    texld r6, r3.xzzw, s15
    add r3.x, r2.z, -r6.x
    cmp r3.x, r3.x, c6.w, c6.x
    add r2.w, r2.w, r3.x
    mad r3.xz, r7.xy, c10.zyww, r0.zyww
    texld r6, r3.xzzw, s15
    add r3.x, r2.z, -r6.x
    cmp r3.x, r3.x, c6.w, c6.x
    add r2.w, r2.w, r3.x
    mad r3.xz, r7.xy, c9.xyyw, r0.zyww
    texld r6, r3.xzzw, s15
    add r3.x, r2.z, -r6.x
    cmp r3.x, r3.x, c6.w, c6.x
    add r2.w, r2.w, r3.x
    mad r3.xz, r7.xy, c9.zyww, r0.zyww
    texld r6, r3.xzzw, s15
    add r3.x, r2.z, -r6.x
    cmp r3.x, r3.x, c6.w, c6.x
    add r2.w, r2.w, r3.x
    mad r3.xz, r7.xy, c8.xyyw, r0.zyww
    texld r6, r3.xzzw, s15
    add r3.x, r2.z, -r6.x
    cmp r3.x, r3.x, c6.w, c6.x
    add r2.w, r2.w, r3.x
    mad r3.xz, r7.xy, c8.zyww, r0.zyww
    texld r6, r3.xzzw, s15
    add r3.x, r2.z, -r6.x
    cmp r3.x, r3.x, c6.w, c6.x
    add r2.w, r2.w, r3.x
    mad r3.xz, r7.xy, c7.xyyw, r0.zyww
    texld r6, r3.xzzw, s15
    add r3.x, r2.z, -r6.x
    cmp r3.x, r3.x, c6.w, c6.x
    add r2.w, r2.w, r3.x
    mad r3.xz, r7.xy, c7.zyww, r0.zyww
    texld r6, r3.xzzw, s15
    add r3.x, r2.z, -r6.x
    cmp r3.x, r3.x, c6.w, c6.x
    add r2.w, r2.w, r3.x
    mad r0.zw, r7.xyxy, c5.xyxy, r0
